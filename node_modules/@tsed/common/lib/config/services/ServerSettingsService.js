...
let ServerSettingsService = ServerSettingsService_1 = class ServerSettingsService {
    constructor() {
        ...
        exports.GlobalServerSettings = exports.globalServerSettings = this;
    }
    /**
     *
     * @returns {any}
     ...
     */
    set debug(debug) {
        this.logger = Object.assign({}, this.logger, { debug, level: "debug" });
    }
    /**
     *
...
di_1.registerFactory(ServerSettingsService);
