...
const LogIncomingRequestMiddleware_1 = require("../../mvc/components/LogIncomingRequestMiddleware");
const expressApplication_1 = require("../../mvc/decorators/class/expressApplication");
...
class ServerLoader {
    ...
    constructor() {
        ...
        const settings = ServerSettingsService_1.ServerSettingsService.getMetadata(this);
        this._injector = createInjector_1.createInjector(settings);
        createExpressApplication_1.createExpressApplication(this._injector);
        if (settings) {
     ...
     */
    get httpServer() {
        return this.injectorService.get(httpServer_1.HttpServer);
    }
    /**
     ...
     */
    get httpsServer() {
        return this.injectorService.get(httpsServer_1.HttpsServer);
    }
    /**
     *
     * @returns {any}
    ...
    createHttpsServer(options) {
        createHttpsServer_1.createHttpsServer(this.injector, options);
    ...
    loadSettingsAndInjector() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (level && this.settings.env !== "test") {
                ts_log_debug_1.$log.level = level;
            }
