 ...
 * @param method
 */
ParamRegistry.isInjectable = (target, method) => (core_1.Metadata.get(constants_1.PARAM_METADATA, target, method) || []).length > 0;
/**
 *
 * @param target
 * @param propertyKey
 */
ParamRegistry.hasNextFunction = (target, propertyKey) => ParamRegistry.getParams(target, propertyKey).findIndex(p => p.service === constants_1.EXPRESS_NEXT_FN) > -1;
